...
// FOR DATA
    ...
    private List<Starter> menus;
    private RequestManager glide;
    private Context context;

// CONSTRUCTOR

    public RecyclerStarterAdapter(List<Starter> menus, RequestManager glide,Context context) {
        this.menus = menus;
        this.glide = glide;
    ...
    public void onBindViewHolder(RecyclerMenuHolder viewHolder, final int position) {
        ...
        viewHolder.add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Starter starter = menus.get(position);
...
// RETURN THE TOTAL COUNT OF ITEMS IN THE LIST
    ...
    public Starter getRestaurent(int position) {
